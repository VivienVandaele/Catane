...
public class CreationHotSeatPanel extends JPanel {
	...
	public CreationHotSeatPanel(Fenetre f){
		this.f=f;
		setLayout(null);

		imageBackground = new ImageIcon("images/gameBackground.png");
		
		JLabel titre = new JLabel("<HTML><BODY><center><B>Mode Hot Seat</B></center></BODY></HTML>");
